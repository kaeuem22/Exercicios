...
function exerc2() {
    ...
    let n1 = Number(prompt("insira a quantidade de minutos telefônicos usados no mês"))
...
function exerc3() {
    ...
    let n1 = Number(prompt("insira o preço unitário do produto"))
    ...
    resposta.innerHTML = `Preço unitário =  R$ ${n1.toFixed(2)}<br>`
    resposta.innerHTML += `Preço total =  R$ ${n1.toFixed(2)}<br><br>`
    ...
    if(n3 >= resultado){
        ...
        troco = n3 - resultado
        resposta.innerHTML += `Dinheiro insuficiente. <br>Faltam R$ ${troco.toFixed(2)}`
    }
...
function exerc6() {
    ...
    let cod = Number(prompt('Insira o codigo do produto (entre 1 e 5)'))
    let preco = 0
    ...
    resposta.innerHTML = `Produto: ${cod}<br>`
    resposta.innerHTML += `Preço untário ${preco.toFixed(2)}<br><br>`
